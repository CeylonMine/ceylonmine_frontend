    ...
    const handleCalculateRoyalty = async (e)=>{
        ...
        try {
            ...
            if (isNaN(waterGelValue) || isNaN(nh4no3Value) || isNaN(powderFactorValue)) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('All inputs must be valid numbers');
                setLoading(false);
                return;
            }
            if (waterGelValue < 0 || nh4no3Value < 0 || powderFactorValue <= 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Values must be greater than zero');
                setLoading(false);
                return;
            }
            // Show a loading toast that will be dismissed when calculation completes
            const loadingToast = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].loading('Calculating royalty...');
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].dismiss(loadingToast);
                setRoyaltyData(data);
                onCalculated(data);
                ...
                if (errorMessage.includes('Connection failed') || errorMessage.includes('Failed to fetch')) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Cannot connect to the backend server. Please ensure the backend is running.');
